...
public class Version{
    ...
    public static String combined(){
        ...
        return "Mindustry build " + build + (revision == 0 ? "" : "." + revision) + ", TSR Client build " + tsr_build;
    }
}
